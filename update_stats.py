#!/usr/bin/env python3
"""
Build and refresh the Cloudflare GitHub repository catalog.

The script fetches public GitHub metadata for repositories in Cloudflare's
cloudflare organization that were updated in the last three months and have more
...
USER_AGENT = "cloudflare-repos-catalog"
AUTO_KEYWORD_TERMS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ("Workers", ("workers", "workerd", "wrangler")),
    ("Pages", ("pages", "pages.dev")),
    ("Durable Objects", ("durable object", "durable objects")),
    ("R2", ("r2",)),
    ("KV", (" workers kv", "kv store", "key-value")),
    ("D1", ("d1",)),
    ("AI", ("artificial intelligence", "workers ai", "workers-ai")),
    ("Agents", ("agent", "agents", "agentic")),
    ("MCP", ("mcp", "model context protocol")),
    ("LLM", ("large language model", "llm", "language model")),
    ("QUIC", ("quic", "http/3", "http3")),
    ("Pingora", ("pingora",)),
    ("WireGuard", ("wireguard", "boringtun")),
    ("eBPF", ("ebpf", "xdp", "bpf")),
    ("Terraform", ("terraform", "terraforming")),
    ("Rust", ("rust",)),
    ("Go", ("golang", " go ")),
    ("TypeScript", ("typescript",)),
    ("WASM", ("wasm", "webassembly")),
    ("TLS", ("tls", "ssl", "pki")),
    ("Tunnel", ("cloudflared", "cloudflare tunnel", "tunnel")),
    ("OAuth", ("oauth",)),
...
CLUSTERS: tuple[Cluster, ...] = (
    Cluster(
        ...
        "Workers, Pages & Runtime",
        "Workers runtime, Wrangler, Pages, Durable Objects, WASM bindings, templates, and edge developer platform.",
        "orange",
        (
            "capnweb",
            "durable object",
    ...
    Cluster(
        "ai-agents-mcp",
        "AI, Agents & MCP",
        "Agent frameworks, MCP servers, sandbox runtimes, vibe-coding platforms, and Workers AI tooling.",
        "purple",
        (
            "agent",
    ...
    Cluster(
        ...
        "QUIC, HTTP/3, Pingora, WireGuard, HTML rewriting, packet capture, and edge performance tooling.",
        "cyan",
        (
            "boringtun",
            "http/3",
    ...
    Cluster(
        ...
        "TLS toolkits, certificate issuance, cryptographic libraries, Privacy Pass, and keyless TLS.",
        "green",
        (
            "certificate",
            "cfssl",
    ...
    Cluster(
        "sdks-apis-iac",
        "SDKs, APIs & Infrastructure as Code",
        "Official API clients, Terraform, cloudflared, and tools for managing Cloudflare resources as code.",
        "yellow",
        (
            "api client",
            "cloudflared",
    ...
    Cluster(
        ...
        "Observability, Systems & Libraries",
        "eBPF exporters, Prometheus tooling, service foundations, filesystems, and shared Go/Rust libraries.",
        "red",
        (
            "ebpf",
            "exporter",
    ...
    Cluster(
        "docs-templates-community",
        "Docs, Templates & Community",
        "Developer documentation, starters, examples, WordPress plugins, and public-facing open source sites.",
        "blue",
        (
            "blog",
            "docs",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Update Cloudflare GitHub repository catalog.")
...
def cluster_repo(repo: dict[str, Any]) -> Cluster:
    ...
    name_overrides = {
        "workerd": "workers-pages-runtime",
        "workers-sdk": "workers-pages-runtime",
        "workers-rs": "workers-pages-runtime",
        "workers-types": "workers-pages-runtime",
        "wrangler-action": "workers-pages-runtime",
        "templates": "workers-pages-runtime",
        "partykit": "workers-pages-runtime",
        "capnweb": "workers-pages-runtime",
        "kumo": "workers-pages-runtime",
        "vinext": "workers-pages-runtime",
        "chanfana": "workers-pages-runtime",
        "workers-oauth-provider": "workers-pages-runtime",
        "serverless-registry": "workers-pages-runtime",
        "puppeteer": "workers-pages-runtime",
        "python-workers-examples": "workers-pages-runtime",
        "containers": "workers-pages-runtime",
        "workers-for-platforms-example": "workers-pages-runtime",
        "agents": "ai-agents-mcp",
        "agents-starter": "ai-agents-mcp",
        "computer": "ai-agents-mcp",
        "cloudflare-os": "ai-agents-mcp",
        "cloudflare-os-starter": "ai-agents-mcp",
        "vibesdk": "ai-agents-mcp",
        "mcp": "ai-agents-mcp",
        "mcp-server-cloudflare": "ai-agents-mcp",
        "ai": "ai-agents-mcp",
        "skills": "ai-agents-mcp",
        "sandbox-sdk": "ai-agents-mcp",
        "security-audit-skill": "ai-agents-mcp",
        "claude-managed-agents": "ai-agents-mcp",
        "artifact-fs": "ai-agents-mcp",
        "pingora": "networking-protocols",
        "quiche": "networking-protocols",
        "boringtun": "networking-protocols",
        "lol-html": "networking-protocols",
        "wirefilter": "networking-protocols",
        "speedtest": "networking-protocols",
        "xdpcap": "networking-protocols",
        "isbgpsafeyet.com": "networking-protocols",
        "telescope": "networking-protocols",
        "cfssl": "security-pki-crypto",
        "cfssl_trust": "security-pki-crypto",
        "circl": "security-pki-crypto",
        "boring": "security-pki-crypto",
        "gokeyless": "security-pki-crypto",
        "gokey": "security-pki-crypto",
        "svg-hush": "security-pki-crypto",
        "pp-browser-extension": "security-pki-crypto",
        "origin-ca-issuer": "security-pki-crypto",
        "sslconfig": "security-pki-crypto",
        "cloudflared": "sdks-apis-iac",
        "cloudflare-go": "sdks-apis-iac",
        "cloudflare-typescript": "sdks-apis-iac",
        "cloudflare-python": "sdks-apis-iac",
        "cloudflare-php": "sdks-apis-iac",
        "terraform-provider-cloudflare": "sdks-apis-iac",
        "cf-terraforming": "sdks-apis-iac",
        "ebpf_exporter": "observability-systems",
        "pint": "observability-systems",
        "foundations": "observability-systems",
        "ecdysis": "observability-systems",
        "wildcard": "observability-systems",
        "cbpf": "observability-systems",
        "cloudflare-docs": "docs-templates-community",
        "nimbus": "docs-templates-community",
        "cloudflare-blog": "docs-templates-community",
        "cloudflare.github.io": "docs-templates-community",
        "cloudflare-wordpress": "docs-templates-community",
    }
...
<title>Cloudflare GitHub Repository Atlas</title>
...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  body {{
    ...
    min-height: 100vh;
    background:
      radial-gradient(circle at 85% -10%, rgba(243, 128, 32, 0.22), transparent 28rem),
      radial-gradient(circle at 8% 4%, rgba(251, 191, 36, 0.1), transparent 26rem),
      linear-gradient(180deg, #16120c 0%, var(--bg) 42rem);
    color: var(--text);
  ...
  .logo-box {{
    ...
    place-items: center;
    border-radius: 8px;
    background: linear-gradient(135deg, #f38020, #ffbf5a);
    color: #1a1208;
    font-weight: 800;
    box-shadow: 0 0 24px rgba(243, 128, 32, 0.32);
  }}
  ...
  .search-panel {{
    ...
    border-radius: 12px;
    background:
      radial-gradient(circle at top right, rgba(243, 128, 32), 0.14), transparent 24rem),
  ...
  .search-input:focus {{
    border-color: rgba(243, 128, 32), 0.82);
  ...
  tbody tr:hover {{ background: rgba(243, 128, 32), 0.045); }}
  ...
  .activity-bar span {{
    ...
    background: linear-gradient(90deg, #f38020, #ffbf5a);
  }}
  ...
  .footer a {{ color: var(--cloudflare); text-decoration: none; }}
...
<body>
  <header class="header page-header">
    <h1 class="page-title"><span class="logo-box">CF</span>Cloudflare GitHub Repository Atlas</h1>
    <p>Searchable snapshot of public repositories from Cloudflare's <a href="https://github.com/orgs/cloudflare/repositories" target="_blank" rel="noreferrer">cloudflare organization</a>. Included repositories have more than 200 stars and were pushed within the last three months, since {cutoff}.</p>
...
{extra_section_html}
  ...
  <footer class="footer">
    <p style="margin-bottom: 10px;">Useful links:
      <a class="gh-link" href="https://developers.cloudflare.com/" target="_blank" rel="noreferrer" style="display: inline; margin-left: 6px;">Cloudflare Developers</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://developers.cloudflare.com/workers/" target="_blank" rel="noreferrer" style="display: inline;">Workers</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://blog.cloudflare.com/" target="_blank" rel="noreferrer" style="display: inline;">Cloudflare Blog</a>
    </p>
...
def main() -> int:
    ...
    print(f"Wrote {args.file} with {len(repos)} Cloudflare repositories")
